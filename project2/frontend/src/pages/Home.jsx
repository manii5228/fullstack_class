      ...
      <main style={{ padding: '60px 20px' }}>
        <div className="solid-bento-grid">
          ...
          <div className="flex-col gap-3" style={{ gridColumn: 'span 4', gridRow: 'span 2' }}>
            ...
            <Link to="/register" className="card bg-blue flex-center" style={{ flex: 1, minHeight: '120px', backgroundColor: '#2A8FF7', textDecoration: 'none' }}>
            ...
            {/* Pink Calendar Box */}
            <Link to="/dashboard" className="card bg-pink flex-center" style={{ flex: 1.5, minHeight: '200px', backgroundColor: '#F596C5', textDecoration: 'none' }}>
          ...
          <div className="card bg-maroon flex-center" style={{ gridColumn: 'span 5', gridRow: 'span 2', backgroundColor: '#380D0C', padding: '24px' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', width: '100%' }}>
              {[0, 1, 2].map(i => {
                const e = trending[i] || { event_id: `mock-${i}`, title: 'Coming Soon', category: 'TBA', engagement_score: 80 };
          ...
          <div className="card bg-lime flex-col justify-center" style={{ gridColumn: 'span 4', gridRow: 'span 2', backgroundColor: '#BBE138', padding: '32px' }}>
             <div className="pill-list" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
               {catCounts.map((c, idx) => (
                 <Link to="/events" key={idx} className="pill-item" style={{ background: '#1C260D', color: 'white', borderRadius: 100, padding: '12px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontWeight: 700, textDecoration: 'none' }}>
